 ...
 *
 * クライアント側にも同じ仕様の実装がある（src/logic/dateKeys.js）。
 ...
 */
const daysBetweenLocalDates = (from, to) => {
...
const getTodayKey = () => getTokyoDateKey(new Date());

/** 今月（日本時間）の YYYY-MM。 */
const getCurrentMonthKey = () => getTokyoMonthKey(new Date());
